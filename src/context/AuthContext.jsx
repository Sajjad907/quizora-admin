...
export const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        checkAuth(false); // Initial load is NOT silent

        // Re-check auth on window focus so plan updates (e.g., after Shopify billing) are reflected automatically
        // This is now SILENT to prevent screen flickering
