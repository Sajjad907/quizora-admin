                ...
                {(subscription?.plan === 'Free' || subscription?.plan === 'Starter') && (
                  <button 
                    onClick={(e) => {
                      ...
                      window.open(subscription?.pricingUrl !== '#' ? subscription.pricingUrl : `https://admin.shopify.com/store/${subscription?.shop?.split('.')[0]}/apps/quizora-quiz-app/app/pricing`, "_top");
                    }}
